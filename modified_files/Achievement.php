...
class Achievement extends Model
{
     ...
     */
    public function getAchievementsByUserId($userId,$searchQuery)
    {
        ...
        if(!empty($searchQuery) && isset($searchQuery))
        {
            $sql .= " AND title LIKE :searchQuery1 OR description LIKE :searchQuery2 OR achievement_type LIKE :searchQuery3";
            $param['searchQuery1'] = "%" . $searchQuery . "%";
            $param['searchQuery2'] = "%" . $searchQuery . "%";
            $param['searchQuery3'] = "%" . $searchQuery . "%";
        }
