    ...
    <div class="profile-container">
        ...
        <div class="achievements-container">
             <div class="section-header">
                ...
                <form action="<?= BASE_URL ?>/Uachievements" method="GET">
                    <input type="text" name="searchQuery" style="border-radius: 5rem; padding:1rem">
                    <button type="submit" class="btn add-achievement-btn">Search</button>
                    <button type="reset" onclick="window.location.href='<?= BASE_URL ?>/Uachievements'" class="btn add-achievement-btn"> Reset </button>
                </form>
            </div>
                ...
                <div class="achievement-card">
                    ...
                    <div> 
                        ...
                        <!-- #### Edited for task 02 -->
                            ...
                            <div class="achievement-organization">
                                <strong>Last Edited at:</strong> <?= htmlspecialchars($achievement['updated_at']) ?>
                            </div>
                            <br>
