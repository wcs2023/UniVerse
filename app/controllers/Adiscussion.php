<?php
// filepath: c:\xampp\htdocs\UniVerse\app\controllers\Adiscussion.php

class Adiscussion extends Controller
{
  ...
  public function index() {
    ...
    // Load the view
    $this->view('actors/alumni/Aforum_home', $data);
  }

  public function category($categoryId = null) {
    if (!$categoryId) {
      header("Location: " . BASE_URL . '/adiscussion');
      exit;
    }
    ...
    $this->view('actors/alumni/Aforum_category', $data);
  }
  ...
  public function thread($threadId = null) {
    ...
    $this->view('actors/alumni/Aforum_thread', $data);
  }

  public function create() {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      // For now, just redirect back with success message
      header("Location: " . BASE_URL . '/adiscussion?success=thread_created');
      exit;
    }
    ...
    $this->view('actors/alumni/Aforum_create_thread', $data);
  }
  ...
  public function reply($threadId = null) {
    ...
    // For now, just redirect back with success message
    header("Location: " . BASE_URL . '/adiscussion/thread/' . $threadId . '?success=reply_added');
    exit;
  }
  ...
  public function edit_thread($threadId = null) {
    ...
    $this->view('actors/alumni/Aforum_edit_thread', $data);
  }
  ...
  public function edit_post($postId = null) {
    ...
    $this->view('actors/alumni/Aforum_edit_post', $data);
  }
  ...
  public function delete_thread($threadId = null) {
    ...
    header("Location: " . BASE_URL . '/adiscussion?success=thread_deleted');
    exit;
  }
  ...
  public function delete_post($postId = null) {
    ...
    header("Location: " . BASE_URL . '/adiscussion?success=post_deleted');
    exit;
  }
  ...
  public function search() {
    ...
    $this->view('actors/alumni/Aforum_search', $data);
  }
