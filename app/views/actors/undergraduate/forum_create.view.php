    ...
    <main class="main-container">
        <div class="form-container">
            <div class="form-header">
                ...
                <a href="<?= BASE_URL ?>/Udiscussion/index" class="btn-back"><i class="fa-solid fa-arrow-left"></i>Back to Forums</a>
            </div>
            ...
            <form method="POST" action="<?= BASE_URL ?>/Udiscussion/create_posts" class="create-form">
