...
<div class="form-container">
    <div class="form-header">
        ...
        <div class="action-btn">
            <a href="<?= BASE_URL ?>/Udiscussion/index" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i>Back to the Forum</a>
            <a href="<?= BASE_URL ?>/Udiscussion/create_posts" class="btn btn-primary"><i class="fa-solid fa-plus"></i>New Discussion</a>
        </div>
    </div>
    ...
    <div class="forum-table">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="<?= BASE_URL ?>/Udiscussion/view_thread/<?= $thread['thread_id'] ?>" class="thread-title"><?= htmlspecialchars($thread['title']) ?></a>
                        <br>
