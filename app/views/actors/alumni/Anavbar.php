    ...
    <div class="container">
        ...
        <nav class="nav-menu" id="nav-menu" role="navigation" aria-label="Main navigation">
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="<?= BASE_URL ?>/adiscussion" class="nav-link <?= (strpos($current_path, '/adiscussion') !== false) ? 'active' : '' ?>" <?= (strpos($current_path, '/adiscussion') !== false) ? 'aria-current="page"' : '' ?>>Discussion Forums</a>
                </li>
                <li class="nav-item">
