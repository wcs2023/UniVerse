            ...
            <ul class="nav-list">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="degree-finder.html" class="dropdown-item">
                        ...
                        <a href="jobs.html" class="dropdown-item">
                            <span class="dropdown-icon">💼</span>
                            <div>
                        ...
                        <a href="mentorship.html" class="dropdown-item">
                            <span class="dropdown-icon">👥</span>
                            <div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="forums.html" class="dropdown-item">
                            <span class="dropdown-icon">💬</span>
                            <div>
