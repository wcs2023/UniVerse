...
<main class="main-container">
    <section class="hero-section fade-in">
        <div class="hero-content">
            ...
            <div class="try-button">
                <!-- <button class="btn btn-try"><a href="#"></a>Try Now</button> -->
                 <a href="degree_suggestion.php" class="btn btn-try">Try Now</a>

            </div>
        </div>
        <div class="hero-image">
            <div>
                <img src="assets\img\hero_image_home.jpg" alt="" class="placeholder-img">
            </div>
        </div>
    </section>
    ...
    <section class="features-section fade-in">
        <div class="feature-image">
            <div >
                <img src="assets\img\career.jpg" alt="" class="placeholder-img" >
            </div>
        </div>
        <div class="feature-content">
            <h2>Explore Articles and Forums to Enhance Your Career Journey</h2>
            <p class="feature-description">
                Drive into a wealth of articles and engaging forums tailored for you career growth.Connect with peers and industry experts to gain insights and share experiences.
            </p>
            <div class="feature-grid">
                <div class="feature-card">
                    <h3>Career Articles</h3>
                    <p>Stay informed with the latest trends and advice in your fields</p>
                    <a href="#" class="btn btn-outline">Try Now</a> 
                </div>
                <div class="feature-card">
