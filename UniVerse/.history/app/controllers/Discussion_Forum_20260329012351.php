...
class Discussion_Forum extends Controller
{
    ...
    public function like_thread($thread_id = null){
        ...
        $this->jsonResponse(['ok'=>true,'tread_id'=>$thread_id] + $thread_likes);
    }
    ...
    public function dislike_thread($thread_id = null){
        ...
        $this->jsonResponse(['ok'=>true,'tread_id'=>$thread_id] + $thread_dislikes);
    }
        ...
        $user_id = (int)$this->getCurrentUserId();
        $thread_likes = $this->thread_model->setThreadVote($post_id,$user_id,1);
        
        $this->jsonResponse(['ok'=>true,'tread_id'=>$post_id] + $thread_likes);
    }
}
