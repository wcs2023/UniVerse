...
class Discussion_Forum extends Controller
{
    ...
    public function like_thread($thread_id = null){
        ...
        $thread_likes = $this->thread_model->setThreadVote($thread_id,$user_id,1);
        
        $this->jsonResponse(['ok'=>true,'thread_id'=>$thread_id] + $thread_likes);
    }
    ...
    public function dislike_thread($thread_id = null){
        ...
        $user_id = (int)$this->getCurrentUserId();
        $thread_dislikes = $this->thread_model->setThreadVote($thread_id,$user_id,-1);
        
        $this->jsonResponse(['ok'=>true,'thread_id'=>$thread_id] + $thread_dislikes);
    }
        ...
        $user_id = (int)$this->getCurrentUserId();
        $post_likes = $this->thread_model->setThreadVote($post_id,$user_id,1);
        
        $this->jsonResponse(['ok'=>true,'post_id'=>$post_id] + $post_likes);
    }
        ...
        $user_id = (int)$this->getCurrentUserId();
        $post_dislikes = $this->thread_model->setThreadVote($post_id,$user_id,-1);
        
        $this->jsonResponse(['ok'=>true,'post_id'=>$post_id] + $post_dislikes);
    }
}
