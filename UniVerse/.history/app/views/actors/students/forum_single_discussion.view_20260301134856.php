                ...
                <div class="reply" id="reply-<?= htmlspecialchars($post['id']) ?>">
                    ...
                    <div class="reply-content">
                        ...
                        <div class="reply-actions">
                            <button class="reply-action" type="button"><i class="fa-regular fa-thumbs-down"></i> <?= htmlspecialchars($post['likes']) ?> likes</button>
                            <button class="reply-action" type="button">↩️ Reply</button>
                            <?php if (isset($current_user_id) && $current_user_id == $post['author_id']): ?>
                        <div class="post-actions">
                            <button onclick="editPost(<?= $post['id'] ?>)" class="btn-action btn-edit">
                                <i class="fa-solid fa-edit"></i> Edit
                            </button>
                            <button onclick="confirmDelete('post', <?= $post['id'] ?>)" class="btn-action btn-delete">
