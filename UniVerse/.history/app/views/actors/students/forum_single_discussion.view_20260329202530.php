...
<main class="container">
    ...
    <div class="post-card">
        ...
        <div class="post-actions">
            <button class="action-btn" type="button" onclick="voteThread(<?= $thread['thread_id'] ?> ,1)"><i class="fa-regular fa-thumbs-up"></i> Like</button>
            <button class="action-btn" type="button" onclick="voteThread(<?= $thread['thread_id'] ?> ,-11)"><i class="fa-regular fa-thumbs-down"></i> dislike</button>
        </div>
