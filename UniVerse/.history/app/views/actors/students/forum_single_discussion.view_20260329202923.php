...
<main class="container">
    ...
    <div class="post-card">
        ...
        <div class="post-actions">
            <button class="action-btn" type="button" onclick="like_Thread(<?= $thread['thread_id'] ?> ,1)"><i class="fa-regular fa-thumbs-up"></i> Like</button>
            <button class="action-btn" type="button" onclick="voteThread(<?= $thread['thread_id'] ?> ,-1)"><i class="fa-regular fa-thumbs-down"></i> dislike</button>
        </div>
                ...
                <div class="reply" id="reply-<?= htmlspecialchars($post['post_id']) ?>">
                    ...
                    <div class="reply-content">
                        ...
                        <div class="reply-actions">
                            <button class="reply-action" type="button"><?= post ?><i class="fa-regular fa-thumbs-up"></i>  likes</button>
                            <button class="reply-action" type="button"><i class="fa-regular fa-thumbs-down"></i> dislike</button>
