...
<main class="container">
    ...
    <div class="post-card">
        ...
        <div class="post-stats">
            <div class="stat"><strong><?= htmlspecialchars($thread[''])?></strong><span> likes</span></div>
            <div class="stat"><strong>3</strong><span> dislikes</span></div>
        ...
        <div class="post-actions">
            ...
            <button class="action-btn" type="button"><i class="fa-regular fa-thumbs-down"></i> dislike</button>
        </div>
